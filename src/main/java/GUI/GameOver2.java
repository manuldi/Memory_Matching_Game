 ...
 * @author manul
 */
public class GameOver2 extends javax.swing.JDialog {
     ...
     */
    public GameOver2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameOver2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GameOver2 dialog = new GameOver2(new javax.swing.JFrame(), true);
